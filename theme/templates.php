  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+91) 1234567890</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" style="font-size:40px;"href="<?php echo web_root; ?>index.php">JobMob<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Canara Engineering college (CSD Branch) 2nd floor<br>
           Pin-574219 Benjanapadvu,Bantwala.</address>
          <p>
            <i class="icon-phone"></i> (1234567890) - 12345-67890 <br>
            <i class="icon-envelope-alt"></i> jobmobs@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Jobmob 2024 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
